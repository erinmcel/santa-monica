$( document ).ready(function() {
  ...
  sql.execute("SELECT the_geom, address, cartodb_id, date_filed, units FROM {{table_name}} WHERE NOT(the_geom IS NULL OR date_filed IS NULL OR units IS NULL) ORDER BY date_filed ASC", {table_name: 'santa_monica_2018'})
